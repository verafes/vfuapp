...
public final class Table {
    ...
    public enum TBL_STUDENT {STUDENT_ID, PERSON_ID, STUDENT_AD, ID}
    public enum TBL_PROFESSOR {PROFESSOR_ID, PERSON_ID, PROFESSOR_AD, ID}
    public enum TBL_ACADEMIC {ACADEMIC_ID, PERSON_ID, ACADEMIC_AD, ID}
